export default {
    ...
    common: {
        ...
        generatedImageDownloadFailed: "图片已生成，但结果图片下载失败，请重试。",
    },
    settingsPanels: {
    ...
    canvas: {
        ...
        sidePanel: {
            canvas: "画布", assets: "资产", prompts: "我的提示词", resize: "调整左侧面板宽度", elements: "画布元素", select: "选择", searchNodes: "搜索节点", focusNode: "定位到节点", preview: "放大预览", noNodes: "画布暂无节点", clearAll: "取消全选", selected: "已选 {{count}}", exporting: "正在导出选中元素…", exportName: "画布元素-{{count}}个", exported: "已导出 {{count}} 个元素", exportFailed: "导出失败，请重试",
            ...
            searchPrompts: "搜索提示词", noPrompts: "暂无提示词", noSavedPrompts: "还没有收藏提示词", browsePromptLibrary: "去提示词库收藏", uncollectPrompt: "取消收藏", promptCopied: "已复制提示词", copyFailed: "复制失败", loadFailedRetry: "加载失败，点击重试", noMatchingPrompts: "无匹配提示词", sourceEmpty: "该来源暂无提示词", viewDetails: "查看详情",
    ...
    config: {
        ...
        scriptEditor: {
            ...
            settingsHint: "图片或视频脚本可用 /* canvas-settings { ... } */ 注释声明面板选项（只解析注释）。图片可声明 quality、resolution、size 以替换原有质量/分辨率/宽高比选项，hide 可隐藏质量、自定义宽高、透明背景；张数始终显示。视频可声明 resolution、duration。value 必须是接口真值，未声明仍用通用面板。",
            stepAi: "让外部 AI 写",
