export default {
    ...
    modelPlugin: {
        ...
        authoring: {
            ...
            anyModel: "（当前选中的模型）",
            settings: "视频模型可在脚本里用注释声明面板选项（只解析注释，不会执行脚本）。未声明时清晰度仍是 480p / 720p / 1080p 加自定义 p，时长 4–30 秒。示例：\n/* canvas-settings\n{\"resolution\":[{\"value\":\"768P\",\"label\":\"768P\"},{\"value\":\"2K\",\"label\":\"2K\"}],\"duration\":{\"min\":4,\"max\":15}}\n*/\n声明 resolution 后只显示这些清晰度并隐藏自定义 p；params.resolution 会按选项原样传递（例如 768P、2K）。duration 会限制时长滑杆范围。",
        },
    },
    ...
    config: {
        ...
        scriptEditor: {
            ...
            settingsHint: "视频脚本可用 /* canvas-settings { ... } */ 注释声明清晰度选项和时长范围；未声明则使用默认 480p / 720p / 1080p 面板。",
            stepAi: "让外部 AI 写",
