export default {
    ...
    common: {
        ...
        generatedImageDownloadFailed: "The image was generated, but the result image could not be downloaded. Please try again.",
    },
    settingsPanels: {
    ...
    prompts: {
        ...
        favorite: "Collect",
        collected: "Collected",
        uncollected: "Removed from My Prompts",
    ...
    canvas: {
        ...
        toolbar: {
            ...
            themeMode: "Theme", light: "Light", dark: "Dark", darkGray: "Dark gray", gridStyle: "Grid style", dots: "Dots", lines: "Lines", blank: "Blank", imageInfo: "Image info",
        },
        project: {
        ...
        sidePanel: {
            ...
            searchPrompts: "Search prompts", noPrompts: "No prompts", noSavedPrompts: "No saved prompts yet", browsePromptLibrary: "Browse the prompt library", uncollectPrompt: "Remove from My Prompts", promptCopied: "Prompt copied", copyFailed: "Copy failed", loadFailedRetry: "Load failed. Click to retry.", noMatchingPrompts: "No matching prompts", sourceEmpty: "No prompts from this source", viewDetails: "View details",
        ...
        promptTemplates: { title: "Templates", manageTitle: "Prompt templates", search: "Search templates", newTemplate: "New template", manage: "Manage", apply: "Apply", empty: "No templates yet", untitled: "Untitled template", untitledGroup: "Untitled group", name: "Name", scene: "Scene", caption: "Short caption", group: "Group", prompt: "Prompt", negative: "Negative prompt", params: "Parameter notes", groups: "Manage groups", addGroup: "New group", deleteTemplate: "Delete this template?", deleteGroup: "Delete this group? Its templates will move to \"{{name}}\"", lastGroup: "Keep at least one group", noMatch: "No matching templates" },
        ...
        references: { title: "References", select: "Select references from canvas", disconnect: "Disconnect reference", remove: "Remove from these references", insert: "Click to insert {{label}}; drag to reorder", empty: "No content", selecting: "Adding references", choose: "Select", selectingHint: "Select references from canvas · ESC to return", connected: "Connected nodes", assets: "My assets", firstFrame: "First frame", swapFrames: "Swap first and last frames" },
        composer: { title: "Compose prompt", description: "All references are sent; click or use @ to point to one in the prompt", placeholder: "Enter a prompt, then click a reference or use @ to insert it", imagePreview: "Referenced image preview", resources: { image: "Image {{index}}", video: "Video {{index}}", audio: "Audio {{index}}", text: "Text {{index}}", group: "Group {{index}}" } },
        controls: { ratio: "Ratio", duplicate: "Duplicate", upload: "Upload", paste: "Paste", delete: "Delete", images: "{{count}} images", texts: "{{count}} options", generations: "{{count}} runs", reasoning: "Reasoning" },
        ...
        shortcut: {
            ...
            altDragCopy: "Copy image/video nodes without connections",
    ...
    config: {
        ...
        scriptEditor: {
            ...
            settingsHint: "Image and video scripts can declare panel options with a /* canvas-settings { ... } */ comment (the comment is parsed, the script is not executed). Image scripts may declare quality, resolution, and size to replace the existing quality / resolution / aspect-ratio choices, and hide quality, custom W/H, or transparent background. Image count always stays visible. Video scripts may declare resolution and duration. value must be the API value. Undeclared models keep the generic panel.",
