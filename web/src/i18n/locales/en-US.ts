export default {
    ...
    canvas: {
        ...
        references: { title: "References", select: "Select references from canvas", disconnect: "Disconnect reference", remove: "Remove from these references", insert: "Click to insert {{label}}; drag to reorder", empty: "No content", selecting: "Adding references", choose: "Select", selectingHint: "Select references from canvas · ESC to return" },
