export default {
    ...
    modelPlugin: {
        ...
        authoring: {
            ...
            settings: "Video models may declare panel options in a script comment (the comment is parsed, the script is not executed). Without a declaration, quality stays 480p / 720p / 1080p plus a custom p input, and duration stays 4–30 seconds. Example:\n/* canvas-settings\n{\"resolution\":[{\"value\":\"768P\",\"label\":\"768P\"},{\"value\":\"2K\",\"label\":\"2K\"}],\"duration\":{\"min\":4,\"max\":15}}\n*/\nA resolution declaration replaces the default pills and hides the custom p input; params.resolution is passed as the option value (for example 768P or 2K). duration limits the seconds slider.",
        },
    },
    ...
    config: {
        ...
        scriptEditor: {
            ...
            settingsHint: "Video scripts can declare quality options and duration range with a /* canvas-settings { ... } */ comment. Without it, the default 480p / 720p / 1080p panel is used.",
