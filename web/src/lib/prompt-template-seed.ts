import type { PromptTemplateGroup, PromptTemplateSeed } from "@/lib/prompt-templates";

export const CUSTOM_PROMPT_TEMPLATE_GROUP_ID = "custom";

export const DEFAULT_PROMPT_TEMPLATE_GROUPS: PromptTemplateGroup[] = [
    { id: "story", name: "分镜叙事" },
    { id: "camera", name: "空间与机位" },
    { id: "sheet", name: "设定图" },
    { id: "look", name: "质感调节" },
    { id: "custom", name: "我的" },
];
