...
- Use a `228px` node creation menu and label panorama nodes as `360°全景查看器`; keep prompt panels at `638px × 258px` and provide canvas/project actions through the left toolbar with unified tooltips.
